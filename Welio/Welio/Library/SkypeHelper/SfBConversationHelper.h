...
@property (readonly) SfBParticipantVideo *selfVideoCheck;

@property (readonly) SfBParticipantVideo *otherVideoCheck;
...
/// conversation.audio.muted has changed
- (void)conversationHelper:(SfBConversationHelper *)conversationHelper
...
/// conversation.selfParticipant.video.canSetPaused has changed
- (void)conversationHelper:(SfBConversationHelper *)conversationHelper
              videoService:(SfBVideoService *)videoService
     didChangeCanSetPaused:(BOOL)canSetPaused;

- (void)conversationHelper:(SfBConversationHelper *)conversationHelper
         conversationLeave:(SfBConversation *)conversation;
